...
namespace DAL
{
    public class PermissaoDAL
    {
        ...
        private static Permissao PreencherObjeto(SqlDataReader _rd)
        {
            Permissao permissao = new Permissao();
            permissao.Id = Convert.ToInt32(_rd["Id"]);
            permissao.Descricao = _rd["Descricao"].ToString();
            return permissao;
        }
